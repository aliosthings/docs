...
* Kernel: 包括 Rhino RTOS 内核，Yloop, VFS, KV 存储等
* Protocol Stack: 包括 LwIP TCP/IP 协议栈, uMesh等
* Security: 包括 TLS, TFS\(Trusted Framework Service\), TEE\(Trusted Exexcution Environment\)等
* AOS API: AliOS Things 提供给应用软件和中间件的 API
